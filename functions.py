...
def render_angle_and_line(image, landmarks): 
    back_landmark_index = 11  # spine landmark index 
    hip_landmark_index = 23  # left hip landmark index 
...
def alert(angle1,angle2,choice,image,count,en):
    flag=0
    colour=(0,255,0)

    if choice==0 and en==0:
        down_threshold=20
        up_threshold=0
        msg1='Tuck your '
        msg2='Elbows in!'
    elif choice==0 and en==1:
        down_threshold= 180
        up_threshold=172
        msg1='Keep your '
        msg2='back straight!'
    elif choice==1 and en==0:
        down_threshold=30
        up_threshold=0
        msg1='Keep your '
        msg2='back straight!'
    elif choice==2 and en==0:
        down_threshold=180
        up_threshold=160
        msg1='Keep your '
        msg2='back straight!'
    elif choice==3 and en==0:
        msg1='Arms not '
        msg2='symmetric!'
